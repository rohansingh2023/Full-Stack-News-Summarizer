...
const Home = () => {
  ...
  return (
    <div>
      <div className="bg-bgImg3 flex flex-col items-center justify-center bg-no-repeat bg-cover bg-center bg-fixed">
        ...
        <button
          ...
          className="py-3 px-4 -mt-32 mb-32 hover:bg-cyan-400 hover:shadow-md hover:scale-105 bg-cyan-600 text-white rounded-full"
        >
          Summarize Now
        </button>
      </div>
      ...
      <div className="h-96 flex flex-col font-Greatvibes justify-evenly items-center text-cyan-600 text-6xl">
        ...
        <h2 className="text-2xl basis-1 text-gray-500 leading-10 w-full font-BraahOne px-56 text-center">
          We understand you don’t have time to go through long news articles
          everyday. So we cut the clutter and deliver them, in shorts.
        </h2>
      </div>
      ...
      <div className="flex flex-row justify-evenly items-center p-5 min-h-[400px] bg-cyan-200">
        <div className="font-BraahOne text-gray-700 text-3xl">
          <h1>Decide How Much You Want To Cut It Short.</h1>
          <h1>Adjust The Length Of Summary Using Slider</h1>
        </div>
        <div>
          <textarea
            className="text-gray-500 text-xs p-10 rounded-lg cursor-default outline-none mt-10"
            cols="60"
            rows="12"
            value={loremtext.slice(0, textLen)}
            readOnly
          ></textarea>
